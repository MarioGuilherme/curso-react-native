        ...
        return (
            <ImageBackground source={backgroundImage} style={styles.background}>
                ...
                <View style={styles.formContainer}>
                    ...
                    {
                        this.state.stageNew &&
                        <AuthInput icon="asterisk" placeholder="Confirmar Senha" value={this.state.confirmPassword} style={styles.input} secureTextEntry={true} onChangeText={confirmPassword => this.setState({ confirmPassword })}/>
                    }
